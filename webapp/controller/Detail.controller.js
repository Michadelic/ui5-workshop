...
sap.ui.define([
	...
	return BaseController.extend("ui5.workshop.controller.Detail", {
		...
		action: function (oEvent) {
			...
			this.getRouter().navTo("Info", {
				objectId : (oEvent.getParameter("listItem") || oEvent.getSource()).getBindingContext().getProperty("ProductID")
			}, bReplace);
		}
	});
